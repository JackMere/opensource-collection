...
| 4 | 2026-08-24 | openwiki | [langchain-ai/openwiki](https://github.com/langchain-ai/openwiki) | TypeScript、Python、JavaScript | 代码开发工具、AI大模型、文档生成 | 代码库文档生成 | LangChain官方的自维护Wiki CLI，为代码库/个人知识自动编写并持续更新的Markdown文档，供Agent作为记忆读取，支持13种模型与可视化，⭐15.6K |
...
> 按使用场景检索；完整分析见 [docs/](docs/)

### 📌 代码理解与智能检索（2）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [codegraph](https://github.com/colbymchenry/codegraph) | 符号+调用边+影响半径，30+ 语言含 C++ | [docs](docs/codegraph_2026-09-25.md) |
| [AOCI-CODE](https://github.com/aoci-spec/aoci-code) | F/R/A/S 四段式语义索引，纯文本可回滚 | [docs](docs/AOCI-CODE_2026-09-25.md) |

### 📐 架构与流程可视化（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [Archify](https://github.com/tt-a1i/archify) | 五类可交互图，类型化 JSON IR + 五类原子校验 | [docs](docs/Archify_2026-09-23.md) |

### 💬 聊天记录备份与分析（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [WeChat EXP](https://github.com/sunhanaix/pc_wechat_exp) | 微信 4.x 聊天记录备份/解密/分析，内存提 SQLCipher 密钥 | [docs](docs/WeChat-EXP_2026-09-17.md) |

### 📓 工作日志与时间追踪（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [Dayflow](https://github.com/JerryZLiu/Dayflow) | 10 秒采帧批压缩交 AI 还原时间线，支持离线 | [docs](docs/Dayflow_2026-09-17.md) |

### 🎨 前端界面生成提质（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [taste-skill](https://github.com/Leonxlnx/taste-skill) | 三旋钮配置 + 156 条 AI 味禁令 + 机械可验前置检查 | [docs](docs/taste-skill_2026-09-17.md) |

### 🔄 AI研发流程改造（4）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [The AI-Native SDLC Playbook](https://claude.com/blog/the-ai-native-sdlc-playbook) | Anthropic 官方 6 阶段 16 play 框架 | [docs](docs/ai-native-sdlc-playbook_2026-09-15.md) |
| [superpowers](https://github.com/obra/superpowers) | 15 个自动触发技能固化「澄清→方案→TDD→复审」 | [docs](docs/superpowers_2026-09-19.md) |
| [OpenCodeReview](https://github.com/alibaba/open-code-review) | 确定性工程 × Agent 混合架构，token 仅通用 Agent 约 1/9 | [docs](docs/OpenCodeReview_2026-09-21.md) |
| [Matt Pocock Skills](https://github.com/mattpocock/skills) | 38 个可拆改工程技能，grilling 设计树 + CONTEXT.md 共享语言 | [docs](docs/MattPocockSkills_2026-09-24.md) |

### 🔍 知识库构建与RAG问答（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [WeKnora](https://github.com/Tencent/WeKnora) | RAG 问答 + ReAct Agent + 自维护 Wiki 三合一 | [docs](docs/WeKnora_2026-09-15.md) |

### 📖 代码库文档生成（2）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [openwiki](https://github.com/langchain-ai/openwiki) | 为代码库自动编写并维护 Markdown Wiki | [docs](docs/openwiki_2026-08-24.md) |
| [AOCI-CODE](https://github.com/aoci-spec/aoci-code) | F/R/A/S 四段式语义索引，纯文本可回滚 | [docs](docs/AOCI-CODE_2026-09-25.md) |
...
| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [headroom](https://github.com/headroomlabs-ai/headroom) | 上下文压缩层，JSON 省 60-95% token | [docs](docs/headroom_2026-07-24.md) |
| [codegraph](https://github.com/colbymchenry/codegraph) | 符号+调用边+影响半径，30+ 语言含 C++ | [docs](docs/codegraph_2026-09-25.md) |
| [AOCI-CODE](https://github.com/aoci-spec/aoci-code) | F/R/A/S 四段式语义索引，纯文本可回滚 | [docs](docs/AOCI-CODE_2026-09-25.md) |
...
| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [token-monitor](https://github.com/Javis603/token-monitor) | 20+ AI 工具的实时 Token/成本/限额监控 | [docs](docs/token-monitor_2026-07-18.md) |

### 📚 技术资源导航（1）

| 项目 | 一句话定位 | 详情 |
|---|---|---|
| [VPSKnow](https://vpsknow.com/) | 全球云服务器评测、运维教程与网络工具导航 | [docs](docs/vpsknow_2026-07-18.md) |
